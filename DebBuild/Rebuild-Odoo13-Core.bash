...
rsynch_full_path /odoo/releases/13.0/odoo/              "$DEBNAME"/
rsynch_full_path /odoo/releases/13.0/odoo-bin           "$DEBNAME"/
rsynch_full_path /odoo/releases/13.0/requirements.txt   "$DEBNAME"/
